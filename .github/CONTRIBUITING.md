# Contributing to flow-build/cockpit

We'd love for you to contribute to our source code and to flowbuild-cockpit even better than it is
today!
...
- Search [GitHub](https://github.com/flow-build/cockpit/pulls) for an open or closed Pull Request
  that relates to your submission. You don't want to duplicate effort.
- [Fork](https://help.github.com/articles/fork-a-repo/) this repo.
- [Clone](https://help.github.com/articles/cloning-a-repository/) your copy.

```shell
git clone https://github.com/YOUR_USERNAME/cockpit.git -o flow-build-cockpit
cd flow-build-cockpit/
```
...
```shell
git remote add upstream https://github.com/flow-build/cockpit.git
```
...
In GitHub, send a pull request to `cockpit:master`.
If we suggest changes, then:

- Make the required updates.
- Re-run flow-build/cockpit and make sure any and all tests are still passing.
